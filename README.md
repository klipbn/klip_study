...
| [Исследование объявлений о продаже квартир](borrower_beliability_research) | Провести анализ рынка недвижимости Санкт-Петербурга для оценки рынка | *pandas*, *numpy*, *matplotlib.pyplot* |
